...
package Interfaces.LPC1114.GPIO is
  ...
  type GPIO0 is record
    GPIO0DATA : aliased GPIODATA_Array (0..2#100000000000#-1);
  ...
  for GPIO0 use record
    GPIO0DATA at 16#0000# range 0..16#10000#-1;
  ...
  type GPIO1 is record
    GPIO1DATA : aliased GPIODATA_Array (0..2#100000000000#-1);
    Reserved  : aliased Reserved_Space (0..4095);
  ...
  for GPIO1 use record
    GPIO1DATA at 16#0000# range 0..16#10000#-1;
    Reserved  at 16#4000# range 0..16#20000#-1;
  ...
  type GPIO2 is record
    GPIO2DATA : aliased GPIODATA_Array (0..2#100000000000#-1);
    Reserved  : aliased Reserved_Space (0..4095);
  ...
  for GPIO2 use record
    GPIO2DATA at 16#0000# range 0..16#10000#-1;
    Reserved  at 16#4000# range 0..16#20000#-1;
  ...
  type GPIO3 is record
    GPIO3DATA : aliased GPIODATA_Array (0..2#100000000000#-1);
    Reserved  : aliased Reserved_Space (0..4095);
  ...
  for GPIO3 use record
    GPIO3DATA at 16#0000# range 0..16#10000#-1;
    Reserved  at 16#4000# range 0..16#20000#-1;
